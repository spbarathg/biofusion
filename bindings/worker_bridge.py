...
def find_rust_lib():
    ...
    possible_paths = [
        f"rust_core/target/release/libant_bot_core.{LIB_EXT}",
        f"../rust_core/target/release/libant_bot_core.{LIB_EXT}",
        f"./target/release/libant_bot_core.{LIB_EXT}"
    ]
    ...
    build_status = os.system("cd rust_core && cargo build --release")
